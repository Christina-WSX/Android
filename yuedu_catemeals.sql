...
--
-- 表的结构 `yuedu_catemeals`
--

CREATE TABLE IF NOT EXISTS `yuedu_catemeals` (
...
--
-- 转存表中的数据 `yuedu_catemeals`
--

INSERT INTO `yuedu_catemeals` (`cate_id`, `cate_pid`, `cate_name`, `cate_order`) VALUES
(1, 0, '早餐', 1),
(2, 0, '中餐', 2),
(3, 0, '晚餐', 3);
